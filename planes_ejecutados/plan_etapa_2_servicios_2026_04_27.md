...
- [x] Implementación de **DTOs** para el paso de datos (Finalizado: lunes, 27 de abril de 2026, 12:40 PM)
- [x] Desarrollo de Casos de Uso (`CreateFurnace`, `ListFurnaces`) (Finalizado: lunes, 27 de abril de 2026, 12:40 PM)
- [x] Implementación de **Service Hubs** (`FurnaceService`) para desacoplamiento de controladores (Finalizado: lunes, 27 de abril de 2026, 12:40 PM)

### Etapa 3: Infraestructura y Aislamiento
- [x] Implementación de Repositorios concretos usando Eloquent (Finalizado: lunes, 27 de abril de 2026, 12:20 PM)
- [x] Creación de **Mappers** (Eloquent <-> Domain Entity) (Finalizado: lunes, 27 de abril de 2026, 12:20 PM)
...
- [x] Etapa 1: Entidades de Dominio (Finalizado: lunes, 27 de abril de 2026, 12:05 PM)
